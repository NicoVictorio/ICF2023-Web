...
<script type="text/javascript">
    ...
    const q7 = () => {
        ...
        $('.answer7').html(`
            <h5>Untuk pendaftaran, kamu bisa melihat video tutorial melalui link berikut: 
            <a href="https://drive.google.com/drive/folders/1YJGMp7iHz4K-HRvpBX_eqVZMiB_zBZOz?usp=sharing">Video Tutorial Pendaftaran</a>
            </h5>
        `);
